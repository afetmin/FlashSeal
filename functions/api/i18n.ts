const translations = {
  en: {
    ...
    invalidUnlockDelay: "Invalid unlock delay.",
  ...
  ja: {
    ...
    invalidUnlockDelay: "開封遅延の値が無効です。",
  ...
  ko: {
    ...
    invalidUnlockDelay: "열기 지연 값이 올바르지 않습니다.",
